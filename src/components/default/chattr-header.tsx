...
function ChattrHeader({
  ...
  return (
    <div className='dark:bg-chattrPitchBlack rounded-t-chattrRoundedLarge border-chattrGray bg-chattrBackgroundMuted dark:border-chattrTextDark/10 z-40 flex h-14 w-full items-center justify-between border-b px-3 py-2'>
